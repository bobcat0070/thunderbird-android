 ...
 *
 * Most senders publish no brand indicator: of a handful of well known senders checked by hand, two of eight
 * did. All eight websites have an icon, so this is what closes the gap between a mailbox where a few senders
 * are recognisable and one where most are.
 *
